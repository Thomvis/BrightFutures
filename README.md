...
## Compatibility
BrightFutures is compatible with Xcode 6 beta 6. Due to an apparent bug in beta 6 related to recursive generic types, BrightFutures does not work with that beta. I filed a radar: [rdar://18072376](http://openradar.appspot.com/radar?id=6427467279499264).
